export default function Card({id, name, description, image, time}) {
    return ( 
        <div id={id} className="group relative w-cardWidth h-cardHeight rounded-xl overflow-hidden duration-0 border-2 border-transparent origin-bottom after:absolute after:inset-0 hover:scale-102 hover:border-white hover:duration-300 hover:after:bg-backgroundGradient">
