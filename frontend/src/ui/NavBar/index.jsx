...
export default function NavBar() {
    ...
    return (
      <nav className="bg-background flex items-center justify-between px-12 py-2 border-b-2 border-b-primary">
        <img className="w-20 p-2.5" src="assets/images/logo-itvX.webp" alt="Logo"/>
        <div className='flex flex-row gap-4'>
          <a href="#" className='text-white hover:text-primary active:text-primary'>
