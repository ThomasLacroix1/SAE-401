...
<<<<<<<< Updated upstream:backend/var/cache/dev/ContainerUhYUuYy/get_ServiceLocator_KzIi_AIService.php
namespace ContainerUhYUuYy;
========
namespace Container0NkFows;
>>>>>>>> Stashed changes:backend/var/cache/dev/Container0NkFows/get_ServiceLocator_8XHINAService.php
 ...
 */
<<<<<<<< Updated upstream:backend/var/cache/dev/ContainerUhYUuYy/get_ServiceLocator_KzIi_AIService.php
class get_ServiceLocator_KzIi_AIService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.KzIi.aI' shared service.
========
class get_ServiceLocator_8XHINAService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.8XH_INA' shared service.
>>>>>>>> Stashed changes:backend/var/cache/dev/Container0NkFows/get_ServiceLocator_8XHINAService.php
     *
    ...
    {
<<<<<<<< Updated upstream:backend/var/cache/dev/ContainerUhYUuYy/get_ServiceLocator_KzIi_AIService.php
        return $container->privates['.service_locator.KzIi.aI'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
========
        return $container->privates['.service_locator.8XH_INA'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
>>>>>>>> Stashed changes:backend/var/cache/dev/Container0NkFows/get_ServiceLocator_8XHINAService.php
            ...
            'App\\Controller\\ApiController::readCategory' => ['privates', '.service_locator.ohYd3Vy', 'get_ServiceLocator_OhYd3VyService', true],
            'App\\Controller\\ApiController::readMovie' => ['privates', '.service_locator.Wql8jrV', 'get_ServiceLocator_Wql8jrVService', true],
<<<<<<<< Updated upstream:backend/var/cache/dev/ContainerUhYUuYy/get_ServiceLocator_KzIi_AIService.php
========
            'App\\Controller\\ApiController::readMovies' => ['privates', '.service_locator.a4mrkMX', 'get_ServiceLocator_A4mrkMXService', true],
>>>>>>>> Stashed changes:backend/var/cache/dev/Container0NkFows/get_ServiceLocator_8XHINAService.php
