...
return [
    ...
    'App\Controller\UserController::actualUser' => [[], ['_controller' => 'App\\Controller\\UserController::actualUser'], [], [['text', '/user/profile']], [], [], []],
    'App\Controller\UserController::addMovie' => [['id'], ['_controller' => 'App\\Controller\\UserController::addMovie'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/user/addMovie']], [], [], []],
];
